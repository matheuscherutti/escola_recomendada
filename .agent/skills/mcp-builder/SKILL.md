---
name: mcp-builder
description: Use when building MCP servers or designing AI tool interfaces — MCP (Model Context Protocol) server building principles, tool design, resource patterns, best practices.
