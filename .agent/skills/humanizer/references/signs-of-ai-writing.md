# Signs of AI Writing — Full Pattern Reference (English)

> Source: [blader/humanizer](https://github.com/blader/humanizer) v2.8.2 (MIT, Siqi Chen), itself based on [Wikipedia:Signs of AI writing](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing) (WikiProject AI Cleanup). Imported 2026-07-04. The kit's entry point is ../SKILL.md — read THIS file section by section, on demand.
